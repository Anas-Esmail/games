...
word_list = [ "in" , "charcter use to point for inside some thing"], \
     [ "on" ,  "charcter use to point for above some thing"], \
     [ "water" ,  "i am  with out smell or test "], \
     [ "pen" ,  "u need me when u want to write in paper"], \
     [ "at" ,  " charcter use to point for time"], \
     [ "bad" ,  "some thing u sleep in"], \
     [ "int" ,  "use to declare number in program"], \
     ["winter" ,  "falling snew in my season"], \
     [ "ntural" ,  "when call something orginal u mean"], \
